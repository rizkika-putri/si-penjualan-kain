    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Toko Bakal Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Barang</th><th>Jenis Bakal</th><th>Harga Bakal</th><th>Jumlah Terjual</th><th>Warna</th>
                            </tr>
                        </thead>
                        <tbody>
